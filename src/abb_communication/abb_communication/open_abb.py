...
class Robot:
    ...
    def set_joints(self, joints, move_time = 1.0):
        '''
        ...
        msg = "02 "
        for joint in joints[:6]: msg += format(joint*self.scale_angle, "+08.2f") + " " 
        msg += format(move_time,  "+08.2f") + " "
        msg += "#" 
        return self.send(msg)
    ...
    def set_speed(self, speed=[1000,50,50,50]):
        '''
